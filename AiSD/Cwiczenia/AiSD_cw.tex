...
\vspace{1\baselineskip}
\textbf{zadanie 4 lista1} \par
$f(x) \in O(g(x)) \leftrightarrow  \lim_{x \to \infty} \frac{f(x)}{g(x)} < \infty$ \par
1. 
...
\begin{tikzpicture}[level distance=1.5cm,
  ...
  \end{tikzpicture}
    ...
    $h(n) = \Theta(p(n))$, jeśli istnieją takie stałe $c_1, c_2, n_0 \leq 0$, że: \par
    ...
    Zatem istnieją stałe $c_1$, $c_2 \geq 0$, spełniające definicje $\Theta$, \par
