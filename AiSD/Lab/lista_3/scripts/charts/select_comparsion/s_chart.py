...
plt.plot(select3_avg['n'], select3_avg['s'], marker='o', label='Select 3')
plt.plot(select7_avg['n'], select7_avg['s'], marker='o', label='Select 7')
plt.plot(select9_avg['n'], select9_avg['s'], marker='o', label='Select 9')
